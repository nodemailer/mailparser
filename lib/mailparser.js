...
MailParser.prototype._processStateHeader = function(line) {
    ...
    if (!line.length) {
        ...
        if (this._currentNode.attachment) {
            ...
            console.log('<%s>', this._currentNode.meta.generatedFileName);
            console.log(new Buffer(this._currentNode.meta.generatedFileName));
            console.log(crypto.createHash("md5").update(this._currentNode.meta.generatedFileName).digest("hex"));
