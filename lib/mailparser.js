...
MailParser.prototype._processStateHeader = function(line) {
    ...
    if (!line.length) {
        ...
        // ok but some attachments can be textContent with inline and base64...
        if (textContent && (!this._currentNode.meta.contentDisposition || (this._currentNode.meta.contentDisposition == "inline" && this._currentNode.meta.transferEncoding != "base64"))) {
